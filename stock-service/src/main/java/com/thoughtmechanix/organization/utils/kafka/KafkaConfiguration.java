...
import static com.thoughtmechanix.organization.utils.kafka.constant.IKafkaConstants.KAFKA_BROKERS;
...
public class KafkaConfiguration {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KAFKA_BROKERS);
